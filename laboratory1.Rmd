...
This second laboratory assumes certain familiarity with R language. If it its not the case, please complete proposed tutorials prior to work on this laboratory.

### Submit laboratory

In order to complete this laboratory, it will be necessary to fill the `answers_lab1.Rmd` R Markdown file with the answers to the different statements included in this file.
